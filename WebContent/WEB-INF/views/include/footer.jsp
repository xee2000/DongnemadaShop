		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="footer__about">
					...
					<ul>
						<li>주소: 서울특별시 강남구 테헤란로 152 (역삼동, GFC)</li>
						<li>전화번호: 010-1234-1234</li>
						<li>Email: hello@naver.com</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
				<div class="footer__widget">
					...
					<ul>
						...
						<li><a href="#">쇼핑몰 정보 확인</a></li>
						<li><a href="#">쇼핑몰 보안</a></li>
						<li><a href="#">배달 정보</a></li>
						<li><a href="#">개인보호 정책</a></li>
						<li><a href="#">우리 사이트맵</a></li>
					</ul>
					<ul>
			...
			<div class="col-lg-4 col-md-12">
				<div class="footer__widget">
					<h6>지금 뉴스레터에 참여하십시오</h6>
					<p>신 상품 및 프로모션에 대한정보를 이메일로 받으세요.</p>
					<form action="#">
...
<script
	src="<%=request.getContextPath()%>/resources/bootstrap/plugins/bootstrap/js/bootstrap.min.js"></script>
<script
	src="<%=request.getContextPath()%>/resources/bootstrap/js/jquery.nice-select.min.js"></script>
<script
	src="<%=request.getContextPath()%>/resources/bootstrap/js/jquery-ui.min.js"></script>
<script
	src="<%=request.getContextPath()%>/resources/bootstrap/js/jquery.slicknav.js"></script>
